...
function SubscriptionMondayMealModal({ mondayMeal, setMonday, closeModal }) {
  ...
  return (
    <>
      <Modal show={mondayMeal} onHide={handleClose}>
...
export default SubscriptionMondayMealModal;
