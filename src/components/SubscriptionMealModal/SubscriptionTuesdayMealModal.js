...
function SubscriptionTuesdayMealModal({ setTuesday, tuesdayMeal, closeModal }) {
  ...
  return (
    <>
      <Modal show={tuesdayMeal} onHide={handleClose}>
...
export default SubscriptionTuesdayMealModal;
