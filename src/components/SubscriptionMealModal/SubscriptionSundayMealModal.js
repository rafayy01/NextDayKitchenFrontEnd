...
function SubscriptionSundayMealModal({ setSunday, SundayMeal, closeModal }) {
  ...
  return (
    <>
      <Modal show={SundayMeal} onHide={handleClose}>
...
export default SubscriptionSundayMealModal;
