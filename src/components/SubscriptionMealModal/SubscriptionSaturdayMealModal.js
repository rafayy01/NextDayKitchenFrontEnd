...
function SubscriptionSaturdayMealModal({ setSaturday, SaturdayMeal, closeModal }) {
  ...
  return (
    <>
      <Modal show={SaturdayMeal} onHide={handleClose}>
...
export default SubscriptionSaturdayMealModal;
