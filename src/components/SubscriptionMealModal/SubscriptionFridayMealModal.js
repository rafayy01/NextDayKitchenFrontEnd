...
function SubscriptionFridayMealModal({ FridayMeal, setFriday, closeModal }) {
  ...
  return (
    <>
      <Modal show={FridayMeal} onHide={handleClose}>
...
export default SubscriptionFridayMealModal;
